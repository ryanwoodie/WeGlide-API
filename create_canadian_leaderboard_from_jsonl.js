...
No maximum distance bonus\`,
        ...
        function updateLeaderboardOverflowState() {
            ...
            if (hint) {
                ...
                hint.textContent = isDesktop
                    ? 'Scroll horizontally for flights (drag table or Shift + mouse wheel)'
        ...
        function setupLeaderboardDragScroll() {
            ...
            // Desktop convenience: vertical wheel scroll translates to horizontal while table overflows.
