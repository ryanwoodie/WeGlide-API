...
function buildNoClubAlertMessage({ pilotName, bilingual = false } = {}) {
    ...
    const english = `Hi ${firstName},

Thanks for uploading your flight to WeGlide.

Your WeGlide profile does not currently have a club assigned. To qualify for the SAC Decentralized Soaring Contest, please add your club here:
...
Merci d'avoir téléversé votre vol sur WeGlide.

Aucun club n'est actuellement associé à votre profil WeGlide. Pour être admissible au concours décentralisé de l'Association canadienne de vol à voile (SAC), veuillez ajouter votre club ici :
${PROFILE_SETTINGS_URL}

Une fois votre club enregistré, les prochaines mises à jour du classement SAC pourront vous inclure dans le classement par club.
