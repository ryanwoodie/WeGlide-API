...
• Over 200 hrs PIC as of ${seasonStartLabel}? Click here to remove yourself from the under-200 list:
  ${links.dismissLink}
...
• Plus de 200 h PIC au ${seasonStartLabel} ? Cliquez ici pour vous retirer de la liste moins de 200 h :
  ${links.dismissLink}
